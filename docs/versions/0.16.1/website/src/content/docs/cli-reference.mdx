...
herdr channel show            # print the configured channel
herdr channel set preview     # rejected until the fork owns preview infrastructure
herdr channel set stable      # use the fork-owned stable channel
