...
Herdr ships a reusable agent skill file at [`skills/herdr/SKILL.md`](https://github.com/f5-sales-demo/herdr/blob/build-xcsh/skills/herdr/SKILL.md).
...
```text
https://github.com/f5-sales-demo/herdr/blob/build-xcsh/skills/herdr/SKILL.md
```
...
[Open `SKILL.md` on GitHub →](https://github.com/f5-sales-demo/herdr/blob/build-xcsh/skills/herdr/SKILL.md)
